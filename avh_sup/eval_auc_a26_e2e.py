"""
Direct Model AUC Eval — A26_e2e shim
======================================
Wraps eval_e2e_auc.py with E2EModelA26 substituted for E2EModel.
A26: Fine-tune from A9_e2e, direct mean alignment + light DANN on z_sync.
"""
