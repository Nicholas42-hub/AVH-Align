"""
Domain & Label Probe Eval — A35_e2e shim
=========================================
Wraps eval_e2e_domain.py with E2EModelA35 substituted for E2EModel,
and AV1M_E2E_Dataset patched to use the full-path CSV.
