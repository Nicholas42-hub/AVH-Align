"""
Direct Model AUC Eval — A33_e2e shim
======================================
Wraps eval_e2e_auc.py with E2EModelA33 substituted for E2EModel.
A33: A2_e2e + explicit IPW backdoor adjustment (non-adversarial domain predictor).
"""
