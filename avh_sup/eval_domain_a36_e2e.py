"""
Domain & Label Probe Eval — A36_e2e shim
=========================================
Wraps eval_e2e_domain.py with E2EModelA36 substituted for E2EModel,
and AV1M_E2E_Dataset patched to use the full-path CSV.
A36: Conditional GRL + Subspace Split + Class-Conditional Alignment.
  - head._encode returns z_c_inv (384d) as the causal repr,
    so the domain probe evaluates the representation used by the task head.
"""
