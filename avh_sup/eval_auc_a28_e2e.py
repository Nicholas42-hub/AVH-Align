"""
Direct Model AUC Eval — A28_e2e shim
======================================
Wraps eval_e2e_auc.py with E2EModelA28 substituted for E2EModel.
A28: Same as A26 but lr_encoder=5e-6 (raised from 2e-7).
     zsync_centered_domain_AUC = 0.5 → true domain invariance achieved.
"""
