"""
Direct Model AUC Eval — A35_e2e shim
======================================
Wraps eval_e2e_auc.py with E2EModelA35 substituted for E2EModel.
A35: A2_e2e + Sliced Wasserstein Distance + Variance Alignment on z_sync_pool.
Attacks covariance structure (root cause of domain probe staying at ~0.99).
"""
