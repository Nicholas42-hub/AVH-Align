"""
Domain & Label Probe Eval — A33_e2e shim
=========================================
Wraps eval_e2e_domain.py with E2EModelA33 substituted for E2EModel,
and AV1M_E2E_Dataset patched to use the full-path CSV.
A33: use_sg=True + explicit IPW backdoor adjustment.
"""

import sys, types, os

sys.path.insert(0, os.path.dirname(__file__))
from train_e2e_a33 import E2EModelA33
from datasets_e2e import AV1M_E2E_FullPathDataset, FakeAVCeleb_E2E_Dataset, e2e_collate_fn

# Inject E2EModelA33 as "E2EModel"
_fake_train_e2e = types.ModuleType("train_e2e")
_fake_train_e2e.E2EModel = E2EModelA33
