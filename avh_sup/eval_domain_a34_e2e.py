"""Domain & Label Probe Eval — A34_e2e shim."""
import sys, types, os
sys.path.insert(0, os.path.dirname(__file__))
from train_e2e_a34 import E2EModelA34
...
_fake_train_e2e.E2EModel = E2EModelA34
...
spec = importlib.util.spec_from_file_location("__main__", os.path.join(os.path.dirname(__file__), "eval_e2e_domain.py"))
