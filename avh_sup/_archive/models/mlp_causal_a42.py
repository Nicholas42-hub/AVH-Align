"""
AVH-Align A42 — Causal + Domain Adversarial (Frozen Encoder)
=============================================================
...
class AVH_Causal_A42(L.LightningModule):
    """
    A42: frozen-encoder Z_c/Z_s causal model with domain adversarial training.
