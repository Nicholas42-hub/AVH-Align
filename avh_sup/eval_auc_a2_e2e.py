"""
Direct Model AUC Eval — A2_e2e_dadv shim
==========================================
Wraps eval_e2e_auc.py with E2EModelA1DADV substituted for E2EModel,
using the A2_e2e_dadv config (use_sg=True + use_domain=True).

Usage:
  python eval_auc_a2_e2e.py \\
