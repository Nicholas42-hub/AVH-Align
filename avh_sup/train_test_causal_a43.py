"""
A43 — Causal + Domain Adversarial training entry-point (frozen encoder).
...
Usage:
  python train_test_causal_a43.py --config_path configs/A43.yaml --mode train
"""
...
def train(config: dict):
    ...
    model  = AVH_Causal_A43(config=config)
