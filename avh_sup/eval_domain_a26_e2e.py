"""
Domain & Label Probe Eval — A26_e2e shim
=========================================
Wraps eval_e2e_domain.py with E2EModelA26 substituted for E2EModel,
and AV1M_E2E_Dataset patched to use the full-path CSV.
A26: use_sg=True + direct mean alignment + light DANN on z_sync.
"""

import sys, types, os

sys.path.insert(0, os.path.dirname(__file__))
from train_e2e_a26 import E2EModelA26
from datasets_e2e import AV1M_E2E_FullPathDataset, FakeAVCeleb_E2E_Dataset, e2e_collate_fn

# Inject E2EModelA26 as "E2EModel"
_fake_train_e2e = types.ModuleType("train_e2e")
_fake_train_e2e.E2EModel = E2EModelA26
