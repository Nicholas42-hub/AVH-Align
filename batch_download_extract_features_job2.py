#!/usr/bin/env python3
"""
Batch Download & Feature Extraction Pipeline - JOB 2
Processes batches 7-12 (archive parts 141-254)
"""
...
JOB_ID = "job2"
START_BATCH = 47  # Start from batch 47 (part 141)
END_BATCH = 85    # Process through batch 84 (exclusive end) - covers parts 141-254 with batch_size=3
...
def preprocess_batch():
    ...
    cmd = [
        ...
        '--data_path', f"{EXTRACTED_DIR}/train",  # Videos are in train/ subdirectory
