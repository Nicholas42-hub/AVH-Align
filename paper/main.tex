...
\begin{table}[t]
    ...
    \begin{tabular}{llcccc}
        ...
        \method\ (ours) & three-way + domain push-pull & $\mathbf{0.844{\pm}0.036/0.996{\pm}0.001}$ & $1.000{\pm}0.000/1.000{\pm}0.000$ & $\mathbf{0.659{\pm}0.079/0.972{\pm}0.010}$ & $0.999{\pm}0.001/1.000{\pm}0.000$ \\
        \bottomrule
    \end{tabular}}
\end{table}
